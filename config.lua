Config = {
  ...
  ["Framework Options"] = {              -- Enable these only if using a framework.
    ...
    ["Multi Character"] = true           -- Basiclly so the HUD doesn't appear once the player is in the character selector, only appears if they have selected a character (QB/ESX)
  },
